...
declare module "types:assemblyscript/src/diagnostics" {
     ...
     * @license Apache-2.0
     */
    import { Range } from "types:assemblyscript/src/tokenizer";
...
declare module "types:assemblyscript/src/tokenizer" {
     ...
     * @license Apache-2.0
     */
    import { DiagnosticMessage, DiagnosticEmitter } from "types:assemblyscript/src/diagnostics";
...
declare module "types:assemblyscript/src/resolver" {
    ...
    import { TypeNode, TypeName, TypeParameterNode, Node, IdentifierExpression, CallExpression, Expression } from "types:assemblyscript/src/ast";
    import { Type } from "types:assemblyscript/src/types";
...
declare module "types:assemblyscript/src/program" {
    ...
    import { Token, Range } from "types:assemblyscript/src/tokenizer";
...
declare module "types:assemblyscript/src/compiler" {
    ...
    import { Program, ClassPrototype, Class, Element, Enum, Field, Function, Global, Property, VariableLikeElement, File } from "types:assemblyscript/src/program";
...
declare module "types:assemblyscript/src/module" {
    ...
    export class Module {
        ...
        isConstExpression(expr: ExpressionRef, features?: FeatureFlags): boolean;
...
declare module "types:assemblyscript/src/index-wasm" {
    ...
    import { Options } from "types:assemblyscript/src/compiler";
    import { DiagnosticMessage, DiagnosticCategory, formatDiagnosticMessage } from "types:assemblyscript/src/diagnostics";
